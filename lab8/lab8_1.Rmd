...
-Income is a variable, but it isn't in its own column.
-values should be in their own column
...
the days listed do not have their own column under their own variable
the values under the columns for the days do not have their own column
