...
```r
amniota%>% #this doesn't really make sense cause we see -999
...
```r
amphibio%>% #this makes sense because we didn't see -999
...
## 3 Reptilia       6040
```
I think these numbers are reasonable considering how we might not understand the nesting behavior of egg laying organisms or that they do not lay eggs in general.
...
```
I think that the na represent an "unchecked" box among the 4 different options of fossorial, terrestrial, aquatic, or arboreal.  If they are not fossorial species, it will be unchecked by placing an NA value in place.
