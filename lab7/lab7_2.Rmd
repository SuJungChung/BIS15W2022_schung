...
names(life_history)
```
#ifyou look at newborn, you will see not measured!
...
#tells us the percent of how much data is missing!
#doesn't make sense that we know the life span of all animals
```

Notice that `max_life` has no NA's. Does that make sense in the context of this data?
```{r}
hist(life_history$max_life)
#why is there a lot of 0 for the life span?
```
