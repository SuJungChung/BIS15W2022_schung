...
Because we are trying to find the mean of with some missing data, we will not be able to find the average.  This means that the NAs must be defined in order for the computer to complete the task.
