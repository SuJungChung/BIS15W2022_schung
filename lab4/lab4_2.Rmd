...
```{r}
bov_mammals <- filter(new_mammals, family=="Bovidae", mass>450000)
bov_mammals
```
...
```{r}
primate_mammals<- data.frame(mammals, "Lophocebus", "Erythrocebus", "Macaca")

new_primate_mammals<- select(primate_mammals, "family","mass","gestation","newborn")

new_primate_mammals$family[which.min(new_primate_mammals$newborn)]
```
