...
##  2 Abe ~ Male   blue      Icth~ No Hair       191 Dark Hor~ blue       good     
##  3 Abin~ Male   blue      Unga~ No Hair       185 DC Comics red        good     
##  4 Adam~ Male   blue      Human Blond         185 DC Comics <NA>       good     
##  5 Agen~ Male   brown     Human Brown         178 Marvel C~ <NA>       good     
##  6 Alfr~ Male   blue      Human Black         178 DC Comics <NA>       good     
##  7 Angel Male   <NA>      Vamp~ <NA>           NA Dark Hor~ <NA>       good     
##  8 Ange~ Female yellow    Muta~ Black         165 Marvel C~ <NA>       good     
##  9 Anim~ Male   blue      Human Blond         183 DC Comics <NA>       good     
## 10 Ant-~ Male   blue      Human Blond         211 Marvel C~ <NA>       good     
## # ... with 266 more rows, and 1 more variable: weight <dbl>
```
...
## # ... with 1 more variable: weight <dbl>
```
For the bonus question, we originally were looking for superheros over 200 lbs and then we filtered for superheros over 300, this would drastically limit the number of superheros.  But, if we were to just filter superheros over 200 lbs, it shows us 59 results.  The question asking for both weight and height produced 60 results.  There was a superhero that was not 200 lbs, but was over 450 in height.
...
```
Groot has the higher height to weight ratio.
...
```
There are 97 superheros that have accelerated healing, durability, and super strength.
...
##   <chr>       <lgl>   <lgl>               <lgl>              <lgl>              
## 1 Spider-Girl TRUE    TRUE                FALSE              FALSE              
